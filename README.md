...
A Python-based simulation framework for generating a synthetic U.S. consumer credit card portfolio with realistic customer demographics, credit bureau attributes, behavioral spending patterns, delinquency dynamics, and portfolio-level financial outcomes.

The project creates both account-level static data and monthly time-series panel data across a multi-year horizon, modeling the lifecycle of credit card accounts from origination through balance evolution, utilization, payments, delinquency roll rates, and charge-offs.
